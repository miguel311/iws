...
class HealthPlanController extends Controller
{
    ...
    {
        return view('health_plans.index');
    }
    ...
    {
        return view('health_plans.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['result' => true, 'redirect' => route('plan-salud.index')], 200);
    }
    ...
    {
        $commercialPlan = CommercialPlan::find($id);
        return view('health_plans.create', compact('commercialPlan'));
    }
    ...
    {
        return response()->json(['records' => CommercialPlan::where('type', 'HCM')->get()]);
    }
}

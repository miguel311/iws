            ...
            <tab-content title="Información Contratante"
                ...
                <div class="table-responsive-lg" v-for="(user, index) in users">
                    ...
                    <tr>  
                        ...
                        <td>
                            <select class="form-control" v-model="user.sexo">
            ...
            <tab-content title="Planes"
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-control"
                        ...
                        <option v-for="(item, index) in plan"
                                :key="index" :label="item.name"
                                :value="item.id"></option>
                    </select>
                    <select class='form-control'
                            v-model='request.plan_persona_id2'
                            @change='planx()'>
...
<script>
    export default {
        ...
        created() {
            const vm = this;
            //llama los datos
            axios.get('/cotizasalud').then(response => {
        ...
        methods: {
            onComplete() {
                ...
                axios.post('/cotizasalud', params).then((response) =>{
                }).catch(error => {
                    console.log(error);
                });
